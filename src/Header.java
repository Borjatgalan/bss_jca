...
/**
 * <p>Ttulo: SRTLab</p>
 * <p>Descripcin: Prcticas de SRT</p>
 * <p>Copyright: Copyright (c) 2014-18</p>
 * <p>Empresa: DISIT de la UEx</p> 
 * @author Lorenzo M. Martnez Bravo
 * @version 1.0
 */
import java.io.*;

/**
 * Clase para la gestin de la cabecera que se aade los mensajes cifrados (ficheros).
...
public class Header {
  ...
  /**
   * Operacin realizada, codificada segun las definiciones de <code>Options</code>   
   */
   ...
   * @param algorithm1 - nombre estndar del algoritmo 1
   * @param algorithm2 - nombre estndar del algoritmo 2
  ...
  public void test() {
    try {
        ...
        if (fh2.load(fis)){
        	System.out.println("Leido, Operacion: " +fh2.getOperation());
        	System.out.println("Leido, Algoritmo1: "+fh2.getAlgorithm1());
        	System.out.println("Leido, Algoritmo2: "+fh2.getAlgorithm2());
        	System.out.print  ("Leido, Data     : ");
